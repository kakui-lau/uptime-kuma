export default {
    ...
    "disableauth.message2": "Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed Monitor State, taką jak Cloudflare Access.",
    ...
    "Monitor State URL": "Adres Monitor State",
    ...
    aboutKumaURL: "Jeśli pozostawisz pole Adres Monitor State puste, domyślnie będzie to strona projektu na GitHub.",
    ...
    trustProxyDescription: "Zaufaj nagłówkom 'X-Forwarded-*'. Jeśli chcesz uzyskać poprawne IP klienta, a twój Monitor State jest za Nginx lub Apache, powinieneś to włączyć.",
