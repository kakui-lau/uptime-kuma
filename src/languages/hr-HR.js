export default {
    ...
    aboutKumaURL: "Ako je polje \"Monitor State URL\" prazno, koristi se zadana vrijednost koja vodi na GitHub stranicu projekta.",
    ...
    trustProxyDescription: "Vjeruj 'X-Forwarded-*' zaglavljima. Ako želite dobiti ispravnu IP adresu klijenta i Monitor State je iza reverznog proxy poslužitelja, trebate omogućiti ovo.",
