export default {
    ...
    "disableauth.message2": "Bu, Monitor State'nın önünde Cloudflare Access gibi <strong>üçüncü taraf yetkilendirmesi olan</strong> kişiler içindir.",
    ...
    aboutKumaURL: "Monitor State URL alanını boş bırakırsanız, varsayılan olarak Project GitHub sayfası olur.",
    ...
    trustProxyDescription: "'X-Forwarded-*' başlıklarına güvenin. Doğru istemci IP'sini almak istiyorsanız ve Monitor State'nız Nginx veya Apache'nin arkasındaysa, bunu etkinleştirmelisiniz.",
