export default {
    ...
    aboutKumaURL: "ถ้าคุณไม่ใส่ข้อมูลในช่อง Monitor State URL ค่าเริ่มต้นจะเป็นจะเป็น Monitor State Github",
    ...
    trustProxyDescription: "เชื่อ Header 'X-Forwarded-*' ถ้าคุณต้องการไอพีที่ถูกต้องและ Monitor State อยู่ข้างหลัง Nginx หรือ Apache, คุณควรเปิดใช้งาน",
    Examples: "ตัวอย่าง",
