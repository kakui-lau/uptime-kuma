export default {
    ...
    "disableauth.message2": "Έχει σχεδιαστεί για σενάρια <strong>όπου σκοπεύετε να εφαρμόσετε έλεγχο ταυτότητας τρίτου μέρους</strong> μπροστά από το Monitor State, όπως το Cloudflare Access, Authelia ή άλλους μηχανισμούς ελέγχου ταυτότητας.",
    ...
    "Monitor State URL": "Monitor State URL",
    ...
    aboutKumaURL: "Εάν αφήσετε κενό το πεδίο URL Monitor State, θα είναι προεπιλεγμένο στη σελίδα Project GitHub..",
    ...
    About: "Σχετικά με το Monitor State",
    ...
    trustProxyDescription: "Εμπιστευτείτε τις κεφαλίδες 'X-Forwarded-*'. Εάν θέλετε να λάβετε τη σωστή IP πελάτη και το Monitor State σας βρίσκεται πίσω το Nginx ή το Apache, θα πρέπει να το ενεργοποιήσετε.",
